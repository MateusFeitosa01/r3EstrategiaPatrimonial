    ...
    >
      <div className="flex flex-col">
        ...
        <div className="mb-6 flex items-center justify-between">
          <h2 className="text-3xl font-bold tracking-tight text-white group-hover:text-black">
            {title}
          </h2>
          <ArrowRight className="h-6 w-6 text-white transition-all duration-300 ease-in-out group-hover:translate-x-1 group-hover:text-black" />
        </div>
        ...
        {/* Stats Section */}
        <div className="mb-4 flex items-center space-x-4 text-sm text-white group-hover:text-black/80 ">
        ...
        {/* Description */}
        <p className="text-sm leading-relaxed text-white group-hover:text-black/80 transition-colors duration-300">
          {description}
        </p>
      </div>
    </a>
