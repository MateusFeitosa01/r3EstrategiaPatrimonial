...
export default function LiquidGlassButton(props: Props) {
    const {
        label = "GLASS BUTTON",
        font = { fontFamily: "Montserat", fontWeight: 500, fontSize: 40 },
        showText = true,
        ...
        stroke = {
            ...
            width: 0,
            colorA: "rgba(255, 255, 255, 0.35)",
            colorB: "rgba(255, 255, 255, 0.12)",
        },
        light = {
            size: 40,
    ...
    const fill = colors?.fill ?? fillProp ?? "#0D0D0D"
