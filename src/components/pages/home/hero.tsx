...
const ScrollExpandMedia = ({
  ...
  const logoScale = 0.95 + scrollProgress * 0.70;
        ...
        <div className='relative w-full flex flex-col items-center min-h-[100dvh] bg-black'>
          ...
          <div className='relative w-full h-[100dvh] flex flex-col items-center justify-between z-10'>
            ...
            <div
                ...
                >
                {/* Metade 1: Vai para a ESQUERDA (-) */}
                <motion.h2
                    className="text-xl sm:text-3xl md:text-4xl lg:text-5xl font-black tracking-wide text-white/80 transition-none text-center uppercase whitespace-nowrap"
                    style={{ transform: `translateX(-${textTranslateX}vw)` }}
                >
                    Estratégias inteligentes que
                </motion.h2>

                {/* Metade 2 (Do 'constroem' em diante): Vai para a DIREITA (+) */}
                <motion.div
  ...
  />
                    ...
                    <h2 className="text-xl sm:text-3xl md:text-4xl lg:text-5xl font-black tracking-wide text-center text-white/80 uppercase">
                    seu patrimônio.
                    </h2>
                </motion.div>
                </div>

            {/* 3. DATA E SCROLL TO EXPAND (Bottom) */}
            <div className='w-full pb-8 md:pb-12 px-6 flex flex-col items-center justify-center text-center relative z-20 pointer-events-none'>
              {date && (
                <p
                  className='text-lg md:text-xl text-white/80 font-light tracking-wider transition-none mb-1'
                  style={{ transform: `translateX(-${textTranslateX}vw)` }}
                >
                  {date}
                </p>
              ...
              {scrollToExpand && (
                <p
                  className='text-sm md:text-base text-white/70 font-light tracking-widest uppercase transition-none'
                  style={{ transform: `translateX(${textTranslateX}vw)` }}
                >
                  {scrollToExpand}
                </p>
          ...
          <motion.section
            className='flex flex-col w-full px-8 py-10 md:px-16 lg:py-20 bg-black z-20'
            initial={{ opacity: 0 }}
